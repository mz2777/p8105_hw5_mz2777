...
**Comment**: Generally, the association between effect size and power is positive. Larger effect size with lager power. 
```{r}
...
**Comment**: the sample average of estimated slope across tests for which the null is rejected approximately does not equal to the true value of true slope? Because, the mean estimated slope of all cases follow normal distribution with true mean beta 1, while the mean estimated slope of rejected cases is different since the null is rejucted, i.e. estimated slope ≠ true slope.
```{r}
